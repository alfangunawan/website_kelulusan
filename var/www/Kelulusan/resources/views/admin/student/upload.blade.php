...
<div class="row">
    <div class="col-12">
        ...
        <div class="bs-callout-info callout-border-left mt-1 p-1">
            ...
            <p>Silahkan upload data peserta dengan Format File Ini : <a href="/files/format/Template-Data-Peserta-Genesis.xlsx" class="btn btn-sm btn-primary">Download Format Excel</a> </p>
        </div>
        <br>
